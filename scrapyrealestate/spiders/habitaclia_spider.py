...
class HabitacliaSpider(CrawlSpider):
    ...
    def parse(self, response):
        ...
        for nflat in range(len(flats)):
            # Verificar si se encuentra la clase "list-item-logo" dentro de <div class="list-item">
            if flats[nflat].find(class_="list-item-logo"):
                # La clase "list-item-logo" está presente, continuar con la próxima vivienda
                continue
